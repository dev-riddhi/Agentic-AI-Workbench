    ...
    <div className="space-y-5 pb-12">
      ...
      {activeTab === 'chat' && (
        <div className="space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800 shadow-sm space-y-4">
            ...
            <form onSubmit={handleSendPrompt} className="space-y-3">
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 text-[11px] font-mono text-zinc-500">
                <div className="flex items-center gap-3">
                  <span>Press <strong className="text-zinc-700 dark:text-zinc-300">Ctrl + Enter</strong> to execute</span>
                  <span>·</span>
                  <span>Model: <strong className="text-cyan-600 dark:text-cyan-400">{agent.ai_model?.name || agent.model || 'Local Model'}</strong></span>
                  <span>·</span>
                  <span>Max Tools: <strong className="text-zinc-700 dark:text-zinc-300">{agent.max_tool_calls || 40}</strong></span>
                </div>
          ...
          <div className="p-4 rounded-xl bg-white dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs shadow-xs">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <span className="font-bold text-zinc-800 dark:text-zinc-200">Instructions:</span>
                <span className="text-zinc-600 dark:text-zinc-400 font-sans line-clamp-1 max-w-xl">
              ...
              <div className="flex flex-wrap items-center gap-3 text-[11px] font-mono text-zinc-500">
                <span>Trigger: <strong className="text-zinc-700 dark:text-zinc-300 capitalize">{agent.trigger || 'manual'}</strong></span>
                <span>·</span>
                <span>Active Model: <strong className="text-cyan-600 dark:text-cyan-400">{agent.ai_model?.name || agent.model || 'Local Model'}</strong></span>
                <span>·</span>
                <span>Tools Enabled: <strong className="text-zinc-700 dark:text-zinc-300">{configTools.length}</strong></span>
              </div>
            </div>
            ...
            <button
              type="button"
              onClick={() => setActiveTab('config')}
              className="px-3 py-1.5 rounded-lg bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-200 border border-zinc-200 dark:border-zinc-700 text-xs font-medium transition-colors cursor-pointer shrink-0 self-start sm:self-auto"
            >
              Edit Agent Details →
            </button>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900/70 border border-zinc-200 dark:border-zinc-800 shadow-sm space-y-5">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-zinc-200 dark:border-zinc-800/80 pb-3">
              <div className="flex items-center gap-2.5">
                <div className="w-2.5 h-2.5 rounded-full bg-cyan-400 animate-pulse" />
                <h3 className="text-sm font-bold text-zinc-900 dark:text-zinc-100 uppercase tracking-wide font-mono flex items-center gap-2">
            ...
            <div className="p-3.5 rounded-xl bg-zinc-50 dark:bg-zinc-950/80 border border-zinc-200 dark:border-zinc-800/80 flex flex-wrap items-center justify-between gap-3">
                      ...
                      <span
                        className={`flex items-center gap-1.5 px-2.5 py-1 rounded-lg border transition-all ${
                          isCurrent
                            ...
                            : 'bg-zinc-100 dark:bg-zinc-900/50 border-zinc-200 dark:border-zinc-800/60 text-zinc-400 dark:text-zinc-600'
                        }`}
                      >
            ...
            <div className="min-h-[280px] max-h-[640px] overflow-y-auto space-y-4 pr-1">
              {messages.length <= 1 && currentStep === 'idle' ? (
                <div className="p-12 text-center rounded-2xl bg-zinc-50 dark:bg-zinc-950/40 border border-dashed border-zinc-200 dark:border-zinc-800 space-y-2">
                  <Bot className="w-8 h-8 text-zinc-600 mx-auto" />
                  <p className="text-xs font-medium text-zinc-800 dark:text-zinc-300">Agent is currently on standby</p>
                      ...
                      <div
                        className={`max-w-3xl w-full p-4 rounded-2xl text-xs sm:text-sm leading-relaxed relative group ${
                          isUser
                            ...
                            : 'bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-100 rounded-bl-xs shadow-xs'
                        }`}
                      >
                        ...
                        <button
                          ...
                          className="absolute top-2 right-2 p-1.5 rounded-lg bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-200 dark:hover:bg-zinc-800 text-zinc-500 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-200 opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer"
                          title="Copy text"
                        >
                          {copiedId === msg.id ? (
                            ...
                            <div className="space-y-1.5">
                              {msg.toolCalls.map((tc, idx) => {
                                ...
                                return (
                                  <div
                                    key={idx}
                                    className="rounded-xl bg-white dark:bg-zinc-900/90 border border-zinc-200 dark:border-zinc-800/90 overflow-hidden text-xs font-mono shadow-xs"
                                  >
                                    <button
                                      type="button"
                                      onClick={() => toggleToolCallAccordion(accordionKey)}
                                      className="w-full px-3 py-2 flex items-center justify-between text-left hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors cursor-pointer"
                                    >
                                      <div className="flex items-center gap-2">
                                      ...
                                      <div className="flex items-center gap-2">
                                        <span className="text-[10px] text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/10 px-1.5 py-0.5 rounded">
                                          Status: OK
                                        </span>
                                        {isExpanded ? (
                                    ...
                                    {isExpanded && (
                                      <div className="p-3 border-t border-zinc-200 dark:border-zinc-800/80 space-y-2 bg-zinc-950">
                                        {tc.arguments && (
                                          <div>
                                            <span className="text-[10px] uppercase text-zinc-500 block mb-0.5">
                                              Parameters Schema:
                                            </span>
                                            <pre className="p-2 rounded-lg bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-300 text-[11px] overflow-x-auto">
                                        ...
                                        {Boolean(tc.result) && (
                                          <div>
                                            ...
                                            <pre className="p-2 rounded-lg bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-emerald-700 dark:text-emerald-300 text-[11px] overflow-x-auto whitespace-pre-wrap">
        ...
        <div className="p-6 max-w-5xl mx-auto space-y-6 animate-in fade-in duration-150">
          <div className="flex items-center justify-between pb-4 border-b border-zinc-200 dark:border-zinc-800">
            <div>
              ...
              <p className="text-xs text-zinc-600 dark:text-zinc-400 mt-0.5">
                Persistent execution records stored in the <code className="text-cyan-700 dark:text-cyan-400 font-mono">agent_actions</code> database table.
              </p>
            </div>
            <Button
              variant="secondary"
          ...
          {isLoadingActions ? (
            <div className="space-y-4">
              {[1, 2].map((k) => (
                <div key={k} className="p-5 rounded-2xl bg-white/80 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 animate-pulse space-y-3 shadow-xs">
                  <div className="h-4 bg-zinc-200 dark:bg-zinc-800 rounded w-1/4" />
                  <div className="h-16 bg-zinc-100 dark:bg-zinc-800/60 rounded" />
                </div>
              ))}
            </div>
          ) : actions.length === 0 ? (
            <div className="p-12 text-center rounded-2xl bg-white/50 dark:bg-zinc-900/30 border border-zinc-200 dark:border-zinc-800/80 space-y-3 shadow-xs">
              ...
              <div className="space-y-1">
                <p className="text-sm font-semibold text-zinc-800 dark:text-zinc-300">No Execution Records Yet</p>
            ...
            <div className="space-y-4">
              {actions.map((act) => {
                ...
                return (
                  <div
                    key={act.id}
                    className="p-5 rounded-2xl bg-white dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800/80 shadow-sm space-y-4 transition-all hover:border-zinc-300 dark:hover:border-zinc-700/80"
                  >
                    ...
                    {act.prompt && (
                      <div className="space-y-1">
                        ...
                        <div className="p-3 rounded-xl bg-zinc-50 dark:bg-zinc-950/60 border border-zinc-200 dark:border-zinc-800 text-xs text-zinc-800 dark:text-zinc-300 whitespace-pre-wrap leading-relaxed">
                          {act.prompt}
                        </div>
                      </div>
                    )}
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-wider text-zinc-500 font-mono">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 text-cyan-600 dark:text-cyan-400 hover:text-cyan-700 dark:hover:text-cyan-300 normal-case cursor-pointer"
                        >
                          <Copy className="w-3 h-3" />
                          <span>Copy</span>
                        </button>
                      </div>
                      <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-cyan-200 dark:border-cyan-500/20 text-xs text-zinc-900 dark:text-zinc-100 whitespace-pre-wrap font-sans leading-relaxed">
                        {act.final_output}
                      </div>
                    </div>
                    ...
                    {act.tool_calls && Array.isArray(act.tool_calls) && act.tool_calls.length > 0 && (
                      <details className="text-xs text-zinc-600 dark:text-zinc-400">
                        <summary className="cursor-pointer hover:text-zinc-900 dark:hover:text-zinc-200 font-mono text-[11px]">
                          View {act.tool_calls.length} Tool Execution Traces
                        </summary>
                        <div className="mt-2 p-3 rounded-xl bg-zinc-100 dark:bg-zinc-950/80 border border-zinc-200 dark:border-zinc-800/80 font-mono text-[11px] space-y-2 overflow-x-auto max-h-60 overflow-y-auto">
                          {act.tool_calls.map((tc, tcIdx) => (
                            <div key={tcIdx} className="border-b border-zinc-200 dark:border-zinc-800/60 pb-2 last:border-0 last:pb-0">
                              <span className="text-cyan-700 dark:text-cyan-400 font-semibold">{tc.name || 'tool'}</span>
                              <pre className="text-[10px] text-zinc-600 dark:text-zinc-400 mt-1 overflow-x-auto">
