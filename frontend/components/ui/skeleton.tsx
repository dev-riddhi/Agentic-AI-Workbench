...
export function Skeleton({ className = "", ...props }: SkeletonProps) {
  return (
    <div
      className={`bg-zinc-200/80 dark:bg-zinc-800/50 animate-pulse rounded-lg border border-zinc-300/40 dark:border-zinc-800/30 ${className}`}
      {...props}
    />
  );
}
...
export function SkeletonCard() {
  return (
    <div className="glass-card p-5 rounded-2xl flex flex-col justify-between h-[230px]">
      ...
      <div className="pt-3 border-t border-zinc-200 dark:border-zinc-800/60 flex items-center justify-between">
