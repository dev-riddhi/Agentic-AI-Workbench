...
export function Sidebar() {
  ...
  return (
    <aside
      ...
      } bg-[#0a0a0c] border-r border-zinc-800/80 flex flex-col justify-between shrink-0 h-screen sticky top-0 select-none transition-all duration-200 z-30`}
    >
      {/* Top Branding Header */}
      <div className="p-4 border-b border-zinc-900/90">
        ...
        {!isCollapsed ? (
          <div className="px-3 py-2 rounded-xl bg-zinc-900/80 border border-emerald-500/30 flex flex-col gap-1 shadow-inner backdrop-blur-md">
      ...
      <nav className="flex-1 px-3 py-4 space-y-1.5 overflow-y-auto">
          ...
          return (
            <Link
              ...
              className={`group relative flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-medium transition-all duration-150 ${
                isActive
                  ? "bg-cyan-500/10 text-cyan-300 border border-cyan-500/30 shadow-[0_0_16px_-4px_rgba(6,182,212,0.25)]"
        ...
        {!isCollapsed && (
          <>
            <div className="pt-4 px-3 pb-2 text-[10px] font-semibold font-mono uppercase tracking-wider text-zinc-500">
              System
            </div>
            <Link
              href="/"
            ...
            >
              <div className="flex items-center gap-2">
                <Radio className="w-3.5 h-3.5 text-zinc-500 group-hover:text-cyan-400 transition-colors" />
      ...
      <div className="p-3 border-t border-zinc-900/90 bg-zinc-950/60">
        {drawerOpen && !isCollapsed && (
          <div className="mb-3 p-3 rounded-xl bg-zinc-900/95 border border-zinc-800 shadow-xl space-y-2 text-xs backdrop-blur-md animate-in fade-in slide-in-from-bottom-2">
        ...
        <button
          ...
          className={`w-full flex items-center justify-between p-2 rounded-xl hover:bg-zinc-900/80 transition-colors cursor-pointer ${
